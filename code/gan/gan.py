...
class GAN:
    def __init__(self, img_shape, sample_shape=(5,5), latent_dim=128, g_optimizer=Adam(0.0002, 0.5), d_optimizer=Adam(0.0002, 0.5), g_loss='binary_crossentropy', d_loss='binary_crossentropy'):
...
if __name__ == "__main__":
    ...
    gan.train(data=X_train, epochs=2000, batch_size=32, sample_interval=2000)